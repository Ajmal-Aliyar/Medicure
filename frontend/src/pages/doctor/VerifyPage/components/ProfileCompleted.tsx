...
export const ProfileCompleted = () => {
    ...
    return (
        <div className='w-full h-[80vh] flex justify-center items-center '>
            <div className="notifications-container shadow-md p-4 rounded-md outline-1 outline-gray-400">
                <div className="success">
                    <div className="flex">
                        ...
                        <div className="success-prompt-wrap flex flex-col">
                            <p className="success-prompt-heading text-lg font-bold text-green-600">Submited successfully
                            </p><div className="success-prompt-prompt text-gray-600">
