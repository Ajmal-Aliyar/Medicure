...
function Auth() {
    ...
    return (
        ...
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
            ...
            >
                <div className="max-w-md md:w-[300px] mx-auto">
                    <div className="flex items-center space-x-5 justify-center uppercase">
                       <p className="text-3xl font-bold ">medicure</p> 
                    </div>
                    <div className="mt-5">
                        <label
                        ...
                        >E-mail</label>
                        <input
                            className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full focus:outline-black"
                            type="text"
                            id="login"
                        />
                        <label
                    ...
                    <div className="mt-5">
                        <button
                            className="py-2 px-4 border  hover:bg-black focus:ring-black focus:ring-offset-blue-200 hover:text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                            type="submit"
                        >
                            Log in
                        </button>
