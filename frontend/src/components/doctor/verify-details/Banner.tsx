...
function Banner() {
  return (
    <div className="flex justify-between items-center w-full p-5 lg:px-16 bg-white md:shadow-md border-b-2 md:border-0">
        ...
        <button className="border-2 border-[#0c0b3eb5] text-[#0c0b3eb5] rounded-full px-5 py-2 font-medium cursor-pointer transition duration-300 hover:bg-[#0c0b3eb5] hover:text-white active:scale-95">
          Log out
        </button>
      </div>
  )
