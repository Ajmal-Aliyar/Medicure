            ...
            <div className="max-h-[20rem] h-full p-2">
                <div className="border flex p-2 rounded-md items-center relative mb-2">
                    ...
                    <div className="ml-2">
                        ...
                        <p className="text-xs text-neutral-500">4.2 ( 170+ Reviews )</p>
                    </div>
                ...
                <div className="border flex p-2 rounded-md items-center relative">
                    ...
                    {/* <div className="w-14 h-10 bg-neutral-300 rounded-md absolute right-0 mr-2 flex justify-center items-center group active:scale-95">
