...
function BooknowCard() {
    ...
    return (
        <div className="md:px-6 lg:px-28 md:p-3 md:py-3">
        <div className="book-bar h-full bg-gray-50 md:rounded-lg shadow-md md:shadow-xl flex justify-center items-center md:px-10 py-3">
