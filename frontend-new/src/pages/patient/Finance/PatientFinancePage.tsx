...
const PatientFinancePage = () => {
  ...
  return (
    <div className="w-full flex flex-col gap-4 h-full relative">
      <div className="w-full sticky top-0 bg-surface border-b border-border flex justify-between z-10">
        <p className="text-secondary-dark font-medium text-md p-3">
          Transaction History
        </p>
      </div>

      <div className="p-4 overflow-y-auto -mt-7 space-y-3 max-w-xl">
