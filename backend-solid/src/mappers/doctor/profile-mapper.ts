...
export const mapDoctorToDTO = (doctor: IDoctor): DoctorProfileDTO => {
  return {
...
export const mapDoctorUpdate = (
  dto: DoctorProfileUpdateDTO
): Partial<IDoctor> => {
  ...
  if (dto.gender !== undefined) personalUpdates["personal.gender"] = dto.gender;
  ...
  if (dto.street !== undefined) locationUpdates["location.street"] = dto.street;
...
export const mapProfessionalDetails = (
  doctor: IDoctor
): ProfessionalVerificationDTO => {
...
export const mapUpdateProfessionalDetails = (
...
export const mapVerificationProofs = (
  doctor: IDoctor
): VerificationProofsDto => {
  return {
...
export const mapUpdateVerificationProofs = (
