...
//     // async requestWithdrawal(doctorId: string, amount: number): Promise<any> {
//     //     try {
//     //         const balance = await this.walletRepository.getBalance(doctorId);
//     //         if (amount <= 0 || amount > balance) {
//     //             throw new Error('Invalid withdrawal amount or insufficient funds.');
//     //         }
            
//     //         const withdrawalRequest = await this.transactionServices.createTransaction({
//     //             senderId: 'Company',
//     //             recieverId: doctorId,
//     //             amount,
//     //             status: 'Pending',
...
//     //         return { message: 'Withdrawal request submitted', withdrawalRequest };
//     //     } catch (error) {
...
//                 currency: 'inr',
//                 destination: transaction.recieverId, // Assuming the doctor has a connected account
//             });
